   ...
   # Create model  
    ...
    for epoch in range(args.epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            # weight_feature_depth_3 = weightDepth(torch.concat(latent_1,latent_2)) 
            ...
            loss_total = loss_con +  loss_enc + loss_cross
        ...
        with open("loss_avg_sch1_avec_weight_" + country_name + ".csv", 'a') as file:
...
def _save_best_model(model, best_acc, epoch, country_name):
    ...
    torch.save(state,'./checkpoint/' + 'sch1_avec_weight_' + country_name + '.ckpt')
