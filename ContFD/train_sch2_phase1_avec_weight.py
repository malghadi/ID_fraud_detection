...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            loss_total = loss_contrastive_densNet_latent + loss_image_total_1 + loss_image_total_2
        ...
        with open("loss_avg_module_1_sch2_phase1_avec_weight_v2_" + country_name + ".csv", 'a') as file:
...
def _save_best_model(model, best_loss, epoch, country_name):
    ...
    torch.save(state,
               './checkpoint/' + 'sch2_phase1_avec_weight_v2_' + country_name + '.ckpt')
