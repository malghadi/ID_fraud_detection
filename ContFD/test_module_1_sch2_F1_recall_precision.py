...
def main():
    ...
    for country_name in country_list:
        ...
        for testing_length in testing_data_length:
            ...
            path_model = './checkpoint/sch2_phase2_avec_weight_' + country_name + '.ckpt'
            ...
            path_model3D = './checkpoint/sch2_phase1_avec_weight_v2_' + country_name + '.ckpt'
        ...
        if not os.path.isdir('./results'):
                os.makedirs('./results')
        with open("results/F1_scors_sch2.csv", 'a') as file:
        ...
        with open("results/precision_sch2.csv", 'a') as file:
            writer = csv.writer(file)
        ...
        with open("results/recall_sch2.csv", 'a') as file:
            writer = csv.writer(file)
