...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            latent_1, decoder_op_1 = netG(img1)
            ...
            gen_loss =  (weight_feature_depth_cat[0]*gen_fake_loss + weight_feature_depth_cat[1]*loss_image_total_1 + weight_feature_depth_cat[2]*loss_image_total_2)/3
        ...
        if variable_acc > best_acc:
            ...
            torch.save({
                ...
                './checkpoint/' + model_name + '/advNet_full_weight_' + country_name  + '.ckpt')
            

        # save the losses avg in .csv file
        with open("loss_avg_advNet_full_weight_" + country_name + ".csv", 'a') as file:
